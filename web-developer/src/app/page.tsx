      ...
      <section id='prices'>
        <div className="grid max-w-screen-lg px-4 pt-20 pb-4 mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:grid-cols-2 lg:pt-4 bg-slate-200">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="mb-4 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl">Har du et startup, eller kan du acceptere arbejdet sker uden for almindelig kontor tid, så kan jeg tilbyde min hjælp til følgende time priser:</p>
            <ul>
              <li>Cloud konsulent</li>
              <ul>
                <li>1200 DKK/time</li>
              </ul>
              ...
              <li>Frontend/Fullstack udvikling</li>
              <ul>
                <li>950 DKK/time</li>
              </ul>
            </ul>
      ...
      <section id='contact'>
        <div className="grid max-w-screen-lg px-4 pt-20 pb-4 mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:grid-cols-2 lg:pt-4 bg-slate-100">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="mb-4 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl">
